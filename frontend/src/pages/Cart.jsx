    ...
    return (
      <div className="min-h-screen">
        ...
        <div className="max-w-3xl mx-auto px-4 py-20 text-center">
          ...
          <Link to="/shop" className="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700">
            ← Back to Shop
          </Link>
        </div>
        <Footer />
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to="/shop" className="flex items-center gap-2 text-green-600 hover:text-green-700">
